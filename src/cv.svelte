  ...
  <div class="main">
    <section class="section" id="experience">
      ...
      <dl class="card">
        ...
        <dd class="card__details">
          <p>
            ...
            components to be shared across Ticketmaster. I focused on building a
            comprehensive suite of accessible and user-friendly UI components
            that cover the majority of UI patterns I saw across the site.
            They're designed to have solid defaults with extensible APIs so
            developers don't feel like they have to start from scratch all the
            time. They also help us enforce design consistency across our
            products.
          </p>
        </dd>
      </dl>
      <dl class="card">
        ...
        <dd class="card__details">
          <p>
            ...
            resale platform, which is now live for all of the UK & Ireland, and
            about to roll out across Europe.
          </p>
          <p>
            We used primarily React, Redux, Reach Router and Styled Components.
            I was responsible for a lot of the UI development, as well as
            figuring out complex business logic to integrate several different
            legacy backends and bridge the gap between Ticketmaster events and
            Seatwave's resale database.
          </p>
          <p>
            I also built a Node server to coordinate the many internal services
            involved. This had a very robust logging setup as the complex
            architecture meant we needed to do lots of tracking and debugging.
          </p>
        </dd>
      </dl>
      <dl class="card">
        ...
        <dd class="card__details">
          <p>
            My team built the new checkout for customers buying resale tickets
            on ticketmaster.co.uk. It's a server-rendered React app with a
            GraphQL backend, relying on Flow for type-checking. We started out
            with Next.js but ended up rolling our own server-rendering solution
            for better control.
          </p>
          <p>
            As this was a greenfield project I was able to focus on performance,
            user-experience and accessibility. We progressively enhanced the
            site to work without JS, and I created a robust suite of tests with
      ...
      <dl class="card print-break">
        ...
        <dd class="card__details">
          <p>
            Founders & Coders is a free 16 week fullstack JavaScript development
            bootcamp. It was a life-changing experience for me, reinforcing my
            love for web development and teaching others.
          </p>
          <p>
            ...
            rather than frameworks, practised agile design sprints, and did lots
            of testing. I also spent a week teaching the next cohort test-driven
            development
          </p>
        </dd>
      </dl>
      <dl class="card">
        ...
        <dd>
          <p>
            I joined Lick as part of a new initiative to educate the creative
            teams on new technologies. I managed technology campaigns,
            communicating directly with clients and travelled abroad to project
            manage digital installations. My team successfully ran everything
            from one-off experiential events to technology-driven marketing
            campaigns.
          </p>
          <p>
            I was responsible for maintaining the website, which is how I fell
            in love with coding. After teaching myself HTML & CSS, I decided to
      ...
      <section class="section" id="projects">
        ...
        <ul class="projects-grid">
          <li class="card">
            <h3>Imbibe</h3>
            <p>
              An app to tell you what drinks you can make. Built using all the
              cool new React stuff—suspense, hooks and lazy loading.
            </p>
            <a href="https://github.com/oliverjam/imbibe">
              github.com/oliverjam/imbibe
            </a>
          </li>
          <li class="card">
            <h3>Shitty Vegan</h3>
            <p>
              A web app for tracking how many animal products you're eating each
              day. Built with React & Emotion.
            </p>
            <a href="https://github.com/oliverjam/shitty-vegan">
              github.com/oliverjam/shitty-vegan
            </a>
          </li>
        </ul>
      </section>
